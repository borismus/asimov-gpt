...
Your task is to write a tweet that will generate interest in my visual chronology of science & technology project. Obliquely mention that the attached illustration is generated by AI. The tweet should be engaging and informative. It should be no longer than 140 characters. Make it sound scientific and not too promotional, and include popular and relevant hashtags about the history of science, technology, invention, and discovery."""
